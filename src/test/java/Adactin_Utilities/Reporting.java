...
public class Reporting implements ITestListener {
		...
		public void onStart(ITestContext context) {
			...
			reporter=new ExtentSparkReporter("E:\\FrameWorks\\Maven_HybridFrameWork\\Reports\\newone.html");
		...
		public void onTestFailure(ITestResult tr) {
			...
			String screenshotPath=System.getProperty("user.dir")+"\\ScreenShortss\\"+tr.getName()+".png";
